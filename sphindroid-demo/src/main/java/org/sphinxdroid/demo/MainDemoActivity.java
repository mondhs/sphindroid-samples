...
public class MainDemoActivity extends Activity {
    ...
    public void onCreate(Bundle state) {
        ...
        config.setString("-dict", joinPath(appDir, "acoustic_model/lt_lt/lm/demo.dict"));
        ...
        Jsgf jsgf = new Jsgf(joinPath(appDir, "acoustic_model/lt_lt/lm/demo.gram"));
        JsgfRule rule = jsgf.getRule("<demo.COMMAND>");
        int lw = config.getInt("-lw");
        FsgModel fsg = jsgf.buildFsg(rule, recognizer.getLogmath(), lw);
        recognizer.setFsg(GeneralFragment.class.getSimpleName(), fsg);
        recognizer.setSearch(GeneralFragment.class.getSimpleName());
